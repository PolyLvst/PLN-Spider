...
soft_sound = "./assets/sounds/soft-alarm.mp3"
medium_sound = "./assets/sounds/medium-alarm.mp3"
warning_sound = "./assets/sounds/warning-sound.mp3"
warning_bouncy2_sound = "./assets/sounds/warning-bouncy-2.mp3"
security_alarm_sound = "./assets/sounds/security-alarm.mp3"
honk_alarm_sound = "./assets/sounds/honk-alarm-repeat.mp3"
